...
{
    private static readonly string _sourceTexturePath = Application.dataPath + "/SourceSprites";
    private static readonly string _tpOutPath = Application.dataPath + "/Altas/";
    private static readonly string _texturePackerExePath = @"E:\bin\TexturePacker.exe";
